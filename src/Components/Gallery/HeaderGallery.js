...
const HeaderGallery = () => {
    ...
    return (
        <div className="fixed w-full h-12 bg-white shadow-md z-10 flex items-center justify-end p-4 opacity-95 gap-5">
            ...
            >
                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg" className="max-w-full max-h-full">
                    <ellipse cx="23.9584" cy="42.7083" rx="3.125" ry="3.125" fill="#292D32"/>
                    <circle cx="36.4584" cy="42.7083" r="3.125" fill="#292D32"/>
                    <path d="M8.33333 18.75L6.25 18.75" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round"/>
                    <path d="M10.4167 31.25L8.33337 31.25" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round"/>
                    <path d="M10.4167 25H4.16669" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round"/>
                    <path d="M14.0873 13.5417L18.7094 34.2435C18.8625 34.9291 19.4709 35.4167 20.1734 35.4167H39.7473C40.4498 35.4167 41.0582 34.9291 41.2113 34.2435L45.4255 15.3685C45.6347 14.4314 44.9218 13.5417 43.9615 13.5417H14.0873ZM14.0873 13.5417L12.4042 7.35616C12.2265 6.70315 11.6336 6.25 10.9568 6.25H4.16669" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round"/>
                </svg>
                <div className="w-5 h-5 bg-[#FC2872] text-white rounded-full flex items-center justify-center absolute top-0 right-0
                    translate-x-2 -translate-y-1/4
                ">
                    {cardItems.length}
                </div>
            </span>
            ...
            >
                    <svg width="42" height="38" viewBox="0 0 42 38" fill="none" xmlns="http://www.w3.org/2000/svg" className="max-w-full max-h-full">
